...
# Returns all the available voices (can you add your custom ones?)
...
def voice_to_str():
    ...
    with sr.Microphone() as microphone_source:
        ...
        try:
            ...
            speak(
                " I didn't hear you please try saying that again loudly after i say i'm listening")
            return "None"
    return query
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while response == 'no':
            ...
            speak(
                'Say yes if this is correct otherwise say no.. after i say "I\'m Listening\'')
